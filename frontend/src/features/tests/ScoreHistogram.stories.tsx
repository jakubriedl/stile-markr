...
export const Sparse: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvas.getByRole("img", { name: "0 to 10 percent: 2 students" })).toBeInTheDocument();
    expect(canvas.getByRole("img", { name: "10 to 20 percent: 5 students" })).toBeInTheDocument();
  },
};
...
export const PeakInMiddle: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvas.getByRole("img", { name: "50 to 60 percent: 28 students" })).toBeInTheDocument();
  },
};
